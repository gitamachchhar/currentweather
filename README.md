...
#Location Manager is used to detect location, not fused location as we are not continuously tracking the location.</br>
#Dagger is used for injection.</br>
#Room database is used to save data in local.</br>
